...
When "add to my team" button is clicked, the dog should be added to the user's team (the dog, not the breed). The user's team can have a maximum of 10 dogs and cannot have more than 3 dogs of the same breed.
